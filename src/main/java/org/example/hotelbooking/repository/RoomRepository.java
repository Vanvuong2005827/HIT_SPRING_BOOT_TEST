...
public interface RoomRepository extends JpaRepository<Room, String> {
    ...
    @Query("select r from Room r join fetch r.roomType where r.status = AVAILABLE order by r.roomName asc")
    List<Room> findAllByStatusWithRoomType(RoomStatus status);
